...
#RELEASE_DOCKER_REGISTRY ?= 10.6.170.180/uds
...
BUILDER_WORKDIR = /go/src/github.com/DaoCloud/uds-dr
...
.PHONY: gen_client
gen_client:
	${DOCKER_MAKE_CMD} /code-generator/generate-groups.sh all github.com/DaoCloud/uds-dr/pkg/apis/client github.com/DaoCloud/uds-dr/pkg/apis "dr:v1alpha1" --go-header-file /code-generator/boilerplate.go.txt

include ./makefiles/uds-dr-controller.mk
